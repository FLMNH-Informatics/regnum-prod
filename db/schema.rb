...
ActiveRecord::Schema.define(version: 2019_07_09_060044) do
  ...
  create_table "submission_description_citations", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "submission_id"
    t.bigint "citation_id"
    t.index ["citation_id"], name: "index_submission_description_citations_on_citation_id"
    t.index ["submission_id", "citation_id"], name: "index_submission_description_citation", unique: true
  ...
  create_table "submissions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    ...
    t.bigint "primary_phylogeny_citation_id"
    ...
    t.index ["primary_phylogeny_citation_id"], name: "index_submissions_on_primary_phylogeny_citation_id"
  end
