...
ActiveRecord::Schema.define(version: 2024_06_06_124856) do
  ...
  create_table "apomorphies", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "apomorphy_phenotypes", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "apomorphy_refs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "bioportal_ontologies", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "bioportal_id"
    t.string "abbreviation"
    t.text "ontology"
  end

  create_table "characters", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.string "short_name"
  ...
  create_table "citation_attribute_triples", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "citation_id", null: false
    t.string "attribute_name"
    t.string "attribute_value"
  end

  create_table "citations", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.string "updated_by"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "cladename_apomorphies", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "cladename_main_refs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "cladename_id", null: false
    t.integer "citation_id", null: false
  ...
  create_table "cladename_phyl_refs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "cladename_id", null: false
    t.integer "citation_id", null: false
  ...
  create_table "cladename_species", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "cladename_id", null: false
    t.bigint "species_id", null: false
    t.integer "specifier"
  ...
  create_table "cladename_specimens", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "cladename_id", null: false
  ...
  create_table "cladename_users", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "cladename_id", null: false
    t.bigint "user_id", null: false
  ...
  create_table "cladenames", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.bigint "user_id"
  ...
  create_table "differentiae", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "digital_doc_apomorphies", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "apomorphy_id", null: false
  ...
  create_table "digital_doc_citations", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "digital_doc_specimens", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "digital_docs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "parent_id"
  ...
  create_table "ontologies", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "ontologies_users", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "ontology_id"
    t.integer "user_id"
  end

  create_table "ontology", primary_key: "ontology_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", limit: 32, null: false
    t.text "definition"
    t.index ["name"], name: "ontology_name_key", unique: true
  end

  create_table "ontology_compositions", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "genus_id", null: false
  end

  create_table "ontology_concepts", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "uri"
  ...
  create_table "ontology_relationship_terms", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "term"
    t.boolean "super_sub"
  end

  create_table "ontology_relationships", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "ontology_terms", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "term"
  ...
  create_table "phenotypes", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "phenotype_type"
    t.integer "entity_id"
  ...
  create_table "preexisting_name_refs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "citation_id", null: false
  ...
  create_table "preexisting_names", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "author"
    t.string "code"
    t.date "created_at", null: false
    t.bigint "user_id"
  ...
  create_table "publisher_sources", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "species", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "author"
    t.string "code"
  ...
  create_table "species_refs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "citation_id", null: false
    t.bigint "species_id", null: false
  ...
  create_table "specimen_refs", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.bigint "specimen_id", null: false
    t.integer "citation_id", null: false
  ...
  create_table "specimens", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "author"
    t.string "collector"
    t.string "comment"
    t.bigint "species_id", null: false
  ...
  create_table "status", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "status_id"
    t.string "status"
  end

  create_table "status_change", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "submission_citation_attachments", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "submission_id"
